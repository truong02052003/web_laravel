                            ...
                            <div class="header-top-left">
                                <ul class="list-wrap">
                                    ...
                                    <li>
                                        ...
                                        <a href="mailto:info@example.com">truong20030205@gmail.<i class="fa fa-comment" aria-hidden="true"></i></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="menu-wrap">
                                ...
                                <nav class="menu-nav">
                                    <div class="logo">
                                        <a href="index-2.html"><img src="uploads/logo/logo1.png" alt="Logo"></a>
                                    </div>
                                    <div class="navbar-wrap main-menu d-none d-lg-flex">
                                        <ul class="navigation">
                                            <li class="menu-item-has-children"><a href="{{route('home.index')}}">Home</a>
                                            </li>
                                            <li class=""><a href="{{route('home.about')}}">ABOUT US</a></li>
                                            <li class="menu-item-has-children"><a href="#">PRODUCTS</a>
                                                <ul class="sub-menu">
                                                    @foreach ($cats_home as $ch )

                                                    <li><a href="{{route('home.category',$ch->id)}}">{{$ch->name}}</a></li>
                                                    @endforeach
                                                </ul>
                                            </li>
                            ...
                            <ul class="list-wrap">
                                <li class="order-0 order-lg-2">
                                    <div class="footer-logo">
                                        <a href="index-2.html"><img src="uploads/logo/logo1.png" alt=""></a>
                                    </div>
                                </li>
                                <li>
